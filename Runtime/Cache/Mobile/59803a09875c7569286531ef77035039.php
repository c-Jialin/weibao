...
<body>
 ...
 -->		         
	...
	<div style="margin:-20px">
		<img src="/Public/Mobile/images/xtwcn/welcome.png" style="display:block;float:left;height:100%"/>
		<div class="index-right" style="margin-left:200px">
			...
			<div class="index-content" style="width:781px;height:296px;margin:auto;margin-top:50px">
				<div class="left" style="float:left;width:231px">
					<?php if($uid == 3 || UID == 1){?>
                    <a href="index.php?s=/Case/index.html" style="display:block;margin-bottom:10px;text-decoration:none;"><img src="/Public/Mobile/images/xtwcn/informationcaiji.png"  alt=""></a>
                    <?php }?>
					<a href="index.php?s=/Case/daichu.html" style="display:block;text-decoration:none;"><img src="/Public/Mobile/images/xtwcn/casedeal.png"  alt=""></a>
