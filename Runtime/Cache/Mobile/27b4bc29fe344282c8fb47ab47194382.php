...
<div class="page container">
    <div class="jindu">
        ...
        <div class="stage">
            ...
            <span class="<?php if($act == 'zhongshen'){?>active<?php }?>"><a href="<?php echo U('case/last_instance', array('id' => $id, 'act' => 'zhongshen'));?>">审批</a></span><span class="solid">→</span>
    ...
    <div class="information">
        <div class="title <?php if($act == 'zhongshen'){?>active<?php }?>" data-toggle="collapse" href="#zhongshen"
             aria-expanded="<?php if($act == 'zhongshen'){?>true<?php }else{?>false<?php }?>"
             aria-controls="collapseExample">当前阶段：审批<span class="caret"></span></div>
        <form action="<?php echo U('Case/last_instance');?>" method="post">
            <div id="zhongshen" class="submit collapse <?php if($act == 'zhongshen'){?>in<?php }?>">
                ...
                <div class="li">
                    ...
                    <div class="right">
                        ...
                        <span class="span-bottom">审批日期</span>
                        <span class="span-bottom">
                            <?php if(!empty($Clist['last_instance_time'])){ echo $Clist['last_instance_time']; } else { echo date('Y-m-d', time()); }?>
                        </span>
                    </div>
