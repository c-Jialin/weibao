...
<div class="page container">
    <div class="jindu">
        ...
        <div class="stage">
            ...
            <span class="<?php if($act == 'diaodu'){?>active<?php }?>"><a href="<?php echo U('case/dispatch', array('id' => $id, 'act' => 'diaodu'));?>">调度</a></span><span class="solid">→</span>
    ...
    <div class="information">
        <div class="title <?php if($act == 'diaodu'){?>active<?php }?>" data-toggle="collapse" href="#diaodu"
             aria-expanded="<?php if($act == 'diaodu'){?>true<?php }else{?>false<?php }?>"
             aria-controls="collapseExample">当前阶段：调度<span class="caret"></span></div>
        <form action="<?php echo U('Case/dispatch');?>" method="post">
            <div id="diaodu" class="submit collapse <?php if($act == 'diaodu'){?>in<?php }?>">
                <div class="li">
                    <div class="left">流程操作</div>
                    <div class="right">
                        <label>
                            <input type="checkbox" name="checkbox1" value="1" <?php if(in_array(1, unserialize($Clist['checkbox_status']))) echo 'checked'; ?>/>
                            <span class="radio-text"> 报警110</span>
                            <select class="select" name="police_station">
                                <option value="1">委派部门</option>
                            </select>
                        </label>&emsp;
                        <label>
                            <input type="checkbox" name="checkbox2" value="2" <?php if(in_array(2, unserialize($Clist['checkbox_status']))) echo 'checked'; ?>/>
                            <span class="radio-text"> 转专业机构</span>
                            <select class="select" name="turn_professional">
                                <option value="1">选择机构</option>
                            </select>
                        </label>&emsp;
                        <label>
                            <input type="checkbox" name="checkbox3" value="3" <?php if(in_array(3, unserialize($Clist['checkbox_status']))) echo 'checked'; ?>/>
                            <span class="radio-text"> 转相关部门</span>
                            <select class="select" name="turn_related">
                                <option value="">选择部门</option>
                                <option value="1"
                                <?php if($Clist['turn_related'] == 1){?>selected<?php }?>>市级部门</option>
                                <option value="3"
                                <?php if($Clist['turn_related'] == 3){?>selected<?php }?>>社区部门</option>
                            </select>
                        </label>
                    </div>
                ...
                <div class="li">
                    ...
                    <div class="right">
                        <span class="span-bottom">湘潭市民政局<?php echo ($member); ?></span>
                        <span class="span-bottom">调度日期</span>
                        <span class="span-bottom">
                            <?php if(!empty($Clist['dispatch_time'])){ echo $Clist['dispatch_time']; } else { echo date('Y-m-d', time()); }?>
                        </span>
                    </div>
